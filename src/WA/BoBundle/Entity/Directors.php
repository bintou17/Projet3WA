 ...
 * @ORM\Entity(repositoryClass="WA\BoBundle\Repository\DirectorsRepository")
 */
class Directors
{
    /**
    ...
    // add 
    // pour retrouver le fichier image associé stocké sur le server dans notre dossier web/uploads
    public $fileImage;
    ...
    // TODO: age du director
    public function getAge()
    {
       $date = $this->dob->diff(new \DateTime());
 
       return $date->y; 
        # code...
    }

    // le traitement relatif au fichierImage
